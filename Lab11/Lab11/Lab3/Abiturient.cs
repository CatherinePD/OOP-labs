...
namespace Lab3
{
    public partial class Abiturient
    {
        ...
        public Abiturient(string name, string surname, string middleName, string address, string phone, int[] marks, string city)
            :this()
        {
            Name = name;
            Surname = surname;
        ...
        public Abiturient(string name, string surname, string middleName, string address = "Sverdlova", string phone = "7788")
            : this(name, surname, middleName, address, phone, new[] {10, 10, 3, 7, 10}, "Минск")
        {
        }

        public Abiturient(string name, string surname, string middleName, int[] marks, string city)
            : this(name, surname, middleName, "Sverdlova", "7788", marks, city)
        {
        ...
        {
            return $"{Surname} {Name} {MiddleName}, средний балл: {GetAverageMark()}";
        }
